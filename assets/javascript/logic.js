    ...
    function (user) {
      if (user) {
        ...
        $(document).on("click", "#list-beers tr", function () {
          ...
          //changing the display to Yes/No depending of the value Y/N
          ...
          //still getting the values from data method()
          ...
          var havailabilityDescValue = $("<h4>").text("Availability Period: " + availabilityDescValue);
          ...
          $.ajax({
            ...
            method: "GET",
            headers: {
              "x-app-id": "88c637ea", // backup id: 7e095527 original: 87764d56
              "x-app-key": "2b84a03944fd42182d9ad570fa354ada" //fd9ce596a8a662b83bb86f924e19fd1e original: 64b0113675aca1dbf6f67d9df8299556
            }
            ...
            $.ajax({
              ...
              headers: {
                "x-app-id": "88c637ea",
                "x-app-key": "2b84a03944fd42182d9ad570fa354ada"
              }
